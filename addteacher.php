        ...
        <div class="relative bg-gray-200 px-6 pt-10 pb-8 shadow-2xl sm:mx-auto sm:rounded-lg ">
            <div class="mx-auto max-w-md">
                <div class="px-4 text-base leading-7 text-gray-800 antialiased">
                    ...
                    <h1 class="text-center font-medium text-indigo-400 mb-4">ADD TEACHER</h1>

                    <form action = "/cms/uploadt.php" method="POST" class="space-y-4"  enctype="multipart/form-data">

                        <label for="T_ID" class="block w-96 mx-auto font-semibold">Teacher ID
                            <input required type="text" name="T_ID" id="T_ID" placeholder="eg: T01" class="w-96 mx-auto px-3 py-1 border focus:outline-none focus:ring rounded-md flex items-center">
                        </label>
                        ...
                        <label for="photo" class="block w-96 mx-auto font-semibold">Image
                            <input required type="file" name="photo" id="photo" class="w-96 mx-auto px-3 py-1 border focus:outline-none focus:ring rounded-md flex items-center">
                        </label>
                        ...
                        <input type="submit" value="SUBMIT" name="submit" class="w-96 mx-auto bg-indigo-500 rounded-md text-white items-center hover:bg-indigo-700 hover:shadow-md ">
